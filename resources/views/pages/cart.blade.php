            ...
            <section aria-labelledby="cart-heading" class="lg:col-span-7">
                ...
                <ul id="cart" role="list" class="divide-y divide-gray-200 border-t border-b border-gray-200">
                    ...
                    <li class="flex py-6 sm:py-10" data-id="{{ $id }}">
                        ...
                        <img src="{{ $details['image'] }}" alt="{{ $details['name'] }}" class="h-24 w-24 rounded-md object-cover object-center sm:h-48 sm:w-48">
                        </div>
                        ...
                        <div class="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                            ...
                            <div class="mt-1 flex text-sm">
                                ...
                                <p class="ml-4 border-l border-gray-200 pl-4 text-gray-500">{{ $details['name'] }}</p>
                            </div>
